...
class OSC(Dependence):
    def configure(self, build, conf):
        if not conf.CheckLib('lo'):
            raise Exception('Could not find liblo or its development headers.')

class Aubio(Dependence):
    def configure(self, build, conf):
...
class MixxxCore(Feature):
    ...
    def sources(self, build):
        sources = ["mixxxkeyboard.cpp",
                   ...
                   "lights/dmx-eth.cpp",
                   "lights/dmxlight.cpp",
                   "lights/dmxlightmanager.cpp",

                   "lights/lightbrickmanager.cpp",
                   "lights/lightbrick.cpp",

                   "lights/solidcolor.cpp",
                   "lights/controlgroup.cpp",
                   "widget/qcolorpicker.cpp",

                   "lights/lightstate.cpp",
                   "lights/triggermode.cpp",
                   "lights/transitionmode.cpp",
                   "lights/controlmode.cpp",

                   "lights/lightshowcontroller.cpp",

                   "lights/model/controlgroupmodel.cpp",
                   "lights/model/lightmodel.cpp",
                   "lights/model/comboboxdelegate.cpp",
                   "lights/model/colordelegate.cpp",
